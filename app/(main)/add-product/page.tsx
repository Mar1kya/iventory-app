                ...
                <form action={createProduct} className="space-y-6">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-2">
                        <div>
                            ...
                            <input type="number" id="price" name="price" min="0" step="0.01" required className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:border-transparent" placeholder="0.0" />
                        </div>
                        <div>
                    ...
                    <div className="flex gap-5">
                        <button type="submit" className="px-6 py-3 bg-black text-white rounded-lg hover:bg-gray-900">Add Product</button>
